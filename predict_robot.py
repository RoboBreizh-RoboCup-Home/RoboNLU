...
class CommandProcessor(object):
    def __init__(self,session = None):
        ...
        self.slot_classifier = slot_classifier_np('./numpy_para/slot_classifier')
        self.intent_token_classifier = intent_token_classifier_np('./numpy_para/intent_token_classifier')
    ...
    def initONNX(self,path):
        ...
        ort_session  = onnxruntime.InferenceSession(path, sess_options, providers=['CPUExecutionProvider'])
