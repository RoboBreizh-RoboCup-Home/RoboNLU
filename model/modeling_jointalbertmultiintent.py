...
# import AlbertModel
from transformers.models.albert.modeling_albert import AlbertModel, AlbertConfig

from .module import SlotClassifier, IntentTokenClassifier, MultiIntentClassifier, ProClassifier

class JointAlbertTMultiIntent(AlbertModel):
    ...
    def forward(self,
        ...
        outputs = self.albert(input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids)  # last-layer hidden-state, (hidden_states), (attentions)
